...
def elevationBinPlot3Subfigs(x_subp1, x_subp1_lab, x_subp1_2, x_subp1_lab_2, x_subp1_3, x_subp1_lab_3, y_subp1, x2_subp1, y2_subp1, xLabel1,
    ...
    ax.scatter(x_subp1_2, y_subp1, label=x_subp1_lab_2, color='steelblue', zorder=4)
    ax.scatter(x_subp1_3, y_subp1, label=x_subp1_lab_3, color='seagreen', zorder=5)
    ax.scatter(x_subp1_ref, y_subp1_ref, label=x_subp1_lab_ref, color='black', zorder=3)   # otherwise maroon (colorblind tho)
    ax.legend()
